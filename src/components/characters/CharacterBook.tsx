    ...
    (async () => {
      ...
      const built = buildCharacterBookChapters(charData, {
        ...
        narratorSentiment: sentimentRes.data ? {
          ...
          relationship_stage: (sentimentRes.data as any).relationship_stage,
          curiosity: (sentimentRes.data as any).curiosity,
          respect: (sentimentRes.data as any).respect,
          trust: (sentimentRes.data as any).trust,
          amusement: (sentimentRes.data as any).amusement,
          disappointment: (sentimentRes.data as any).disappointment,
          intrigue: (sentimentRes.data as any).intrigue,
          story_value: (sentimentRes.data as any).story_value,
          creativity_score: (sentimentRes.data as any).creativity_score,
          world_interaction_score: (sentimentRes.data as any).world_interaction_score,
          npc_interaction_score: (sentimentRes.data as any).npc_interaction_score,
          exploration_score: (sentimentRes.data as any).exploration_score,
          combat_style_score: (sentimentRes.data as any).combat_style_score,
          story_engagement_score: (sentimentRes.data as any).story_engagement_score,
          story_compatibility: (sentimentRes.data as any).story_compatibility,
          narrator_observations: (sentimentRes.data as any).narrator_observations,
          nickname_history: (sentimentRes.data as any).nickname_history,
        } : null,
      });
