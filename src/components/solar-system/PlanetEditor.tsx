...
export default function PlanetEditor({ 
  ...
  const handleGenerateFromDescription = useCallback((withPreview = false) => {
    if (!description.trim()) {
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => handleGenerateFromDescription(false)}
                      ...
                      <Button
                        ...
                        variant="secondary"
                        size="sm"
                        onClick={() => handleGenerateFromDescription(true)}
                        disabled={!description.trim()}
                        className="gap-1.5"
                      >
