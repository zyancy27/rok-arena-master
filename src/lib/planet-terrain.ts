...
const TERRAIN_KEYWORDS = {
  ...
  // Special features
  crystal: ['crystal', 'crystalline', 'gems', 'mineral', 'quartz', 'geode', 'shard', 'gemstone', 'precious stones'],
  floating: ['floating', 'levitating', 'suspended', 'gravity-defying', 'airborne islands', 'floating islands', 'sky islands', 'hovering', 'drifting landmasses', 'aerial archipelago', 'islands in the sky', 'floating rocks', 'floating continents', 'floating mountains'],
  cave: ['cave', 'cavern', 'underground', 'subterranean', 'tunnels', 'cave systems', 'deep below', 'grotto', 'catacombs', 'labyrinth'],
  barren: ['barren', 'desolate', 'lifeless', 'dead', 'empty', 'sterile', 'uninhabited', 'mostly barren', 'wasteland', 'blasted'],
  toxic: ['toxic', 'poisonous', 'acidic', 'corrosive', 'hazardous', 'dangerous fruit', 'kill anyone', 'noxious', 'venomous'],
  ruins: ['ruins', 'ancient', 'abandoned', 'temple', 'temples', 'relic', 'artifact', 'civilisation', 'monuments', 'ancient ruins', 'crumbling', 'forgotten', 'lost city', 'remnants', 'vestiges', 'archaeology', 'antiquity', 'shrine', 'shrines', 'sanctuary', 'sanctuaries', 'pyramid', 'pyramids', 'ziggurat', 'obelisk', 'monolith', 'standing stones', 'megaliths', 'stonehenge', 'tomb', 'tombs', 'mausoleum', 'necropolis', 'crypt', 'burial', 'memorial', 'statue', 'statues', 'colossus', 'carved', 'engraved', 'inscriptions', 'glyphs', 'hieroglyphs', 'altar', 'altars', 'sacred', 'holy site', 'pilgrimage', 'worship'],
  city: ['city', 'metropolis', 'urban', 'civilization', 'advanced', 'teck', 'tech', 'technological', 'cities', 'capital', 'settlement', 'settlements', 'town', 'towns', 'village', 'villages', 'colony', 'colonies', 'outpost', 'spaceport', 'port', 'harbor', 'harbour', 'citadel', 'fortress', 'castle', 'palace', 'tower', 'towers', 'skyscraper', 'building', 'buildings', 'architecture', 'constructed', 'built', 'infrastructure', 'roads', 'highways', 'bridge', 'bridges', 'dome', 'domed', 'enclosed', 'industrial', 'factory', 'factories', 'mining', 'excavation', 'populated', 'inhabitants', 'residents', 'dwelling', 'housing', 'district', 'quarter', 'sprawl', 'megacity', 'ecumenopolis', 'hive city', 'underground city', 'floating city', 'orbital', 'station'],
  glowing: ['glowing', 'luminous', 'bioluminescent', 'radiant', 'shimmering', 'light', 'luminescent', 'phosphorescent', 'incandescent'],
  magical: ['magical', 'mystic', 'enchanted', 'arcane', 'supernatural', 'powers', 'abilities', 'sorcery', 'wizardry', 'spellbound', 'bewitched'],
  storms: ['storm', 'tempest', 'hurricane', 'cyclone', 'blizzard', 'sandstorm', 'lightning', 'tornado', 'typhoon', 'maelstrom'],
  fungal: ['fungal', 'mushroom', 'spore', 'mycelium', 'fungus', 'toadstool', 'lichen', 'moss'],
  alien: ['alien', 'strange', 'bizarre', 'otherworldly', 'exotic', 'unique', 'not normal', 'isn\'t normal', 'xenobiological', 'extraterrestrial'],
  scarred: ['scarred', 'war-torn', 'devastated', 'crater', 'impact', 'bombardment', 'moving castles', 'battle-scarred', 'ravaged', 'blighted'],
