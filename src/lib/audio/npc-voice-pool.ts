...
const VOICE_POOL: NpcVoiceProfile[] = [
  ...
  // --- Female voices (user-specified) ---
  { voiceId: '7NsaqHdLuKNFvEfjpUno', label: 'Voice-F01', tone: 'warm',    gender: 'female' },
  { voiceId: 'flHkNRp1BlvT73UL6gyz', label: 'Voice-F02', tone: 'calm',    gender: 'female' },
  { voiceId: 'WtA85syCrJwasGeHGH2p', label: 'Voice-F03', tone: 'neutral', gender: 'female' },
  { voiceId: '4tRn1lSkEn13EVTuqb0g', label: 'Voice-F04', tone: 'gruff',   gender: 'female' },
  { voiceId: 'weA4Q36twV5kwSaTEL0Q', label: 'Voice-F05', tone: 'old',     gender: 'female' },
  { voiceId: 'si0svtk05vPEuvwAW93c', label: 'Voice-F06', tone: 'sharp',   gender: 'female' },
  { voiceId: 'a5zfmqTslZJBP0jutmVY', label: 'Voice-F07', tone: 'young',   gender: 'female' },
  { voiceId: 'USEQXnsXRJlw2k9LUzG4', label: 'Voice-F08', tone: 'warm',    gender: 'female' },
  { voiceId: 'WMKg7TxPpPWCryaXE42r', label: 'Voice-F09', tone: 'calm',    gender: 'female' },
  { voiceId: 'VD1if7jDVYtAKs4P0FIY', label: 'Voice-F10', tone: 'neutral', gender: 'female' },
  { voiceId: 'WAhoMTNdLdMoq1j3wf3I', label: 'Voice-F11', tone: 'sharp',   gender: 'female' },
];
