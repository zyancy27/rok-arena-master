export { NarrationController, getNarrationController, type NarrationState, type NarrationStateCallback, type HighlightChangeCallback } from './NarrationController';
