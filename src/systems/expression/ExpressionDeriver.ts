...
export const ExpressionDeriver = {
  ...
  fromText(
    ...
    return {
      ...
      speakerRole,
      text,
      emotion: { type: emotionType as EmotionType, intensity: emotionIntensity },
      bodyLanguage: { urgency, stability, agitation, dominance, fear },
      vocalStyle: { tone: vocalTone as VocalTone, pacing, sharpness, hesitation },
      ...
      environmentInfluence: { biome: biome as BiomeTag, tension, atmosphere },
