...
export function buildCanonicalSceneState(
  ...
  return {
    ...
    actorExpressionIdentity: toStringArray(actorIdentity.expressionIdentity),
    worldHazardFamilies: toStringArray(worldState.hazardFamilies),
    worldTravelPressure: toStringArray(worldState.travelPressure),
    worldCulturalFlavor: toStringArray(worldState.culturalFlavor),
    ...
    npcRelationshipPosture: toStringArray(npcIdentity.relationshipPosture),
    ...
    backgroundBehavior: toStringArray(effectState.backgroundBehavior),
    overlayPersistence: toStringArray(effectState.overlayPersistence),
    pulsePatterns: toStringArray(effectState.pulsePatterns),
    impactBursts: toStringArray(effectState.impactBursts),
    motionTexture: toStringArray(effectState.motionTexture),
    soundCueFamilies: toStringArray(effectState.soundCueFamilies),
    textEmphasisStyle: toStringArray(effectState.textEmphasisStyle),
    narratorHighlightFlavor: toStringArray(effectState.narratorHighlightFlavor),
  };
}
